  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      client.settings.ensure(message.guild.id, {
        suggest: {
          channel: "",
          approvemsg: `<a:tick:955870506337329182> Accepted Idea! Expect this soon.`,
          denymsg: `<a:cross1:953179133511335976> Thank you for the feedback, but we are not interested in this idea at this time.`,
