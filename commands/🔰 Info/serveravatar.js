...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      .addField("<:arrow:955872873577332826> PNG",`[\`LINK\`](${message.guild.iconURL({format: "png"})})`, true)
      .addField("<:arrow:955872873577332826> JPEG",`[\`LINK\`](${message.guild.iconURL({format: "jpg"})})`, true)
      .addField("<:arrow:955872873577332826> WEBP",`[\`LINK\`](${message.guild.iconURL({format: "webp"})})`, true)
