...
module.exports = {
  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    try {
      ...
      .addField("<:arrow:955872873577332826> PNG",`[\`LINK\`](${guild.iconURL({format: "png"})})`, true)
      .addField("<:arrow:955872873577332826> JPEG",`[\`LINK\`](${guild.iconURL({format: "jpg"})})`, true)
      .addField("<:arrow:955872873577332826> WEBP",`[\`LINK\`](${guild.iconURL({format: "webp"})})`, true)
