  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    let color = options.getString("color");
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:arrow:955872873577332826> **Name**', json.name, true)
        .addField("<:arrow:955872873577332826> **Hex**", json.hex, true)
        .addField("<:arrow:955872873577332826> **RGB**", json.rgb, true)
        .addField(`<:arrow:955872873577332826> **${client.la[ls].cmds.info.color.brightershade}**`, json.brightened, true)
